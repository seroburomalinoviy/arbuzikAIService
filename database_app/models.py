...
class Subscription(models.Model):
    ...
    character_model = models.ForeignKey('CharacterModel', on_delete=models.CASCADE)
...
class CharacterModel(models.Model):
    model_index = models.CharField('index of model', max_length=500, editable=True, unique=True)
    file_path = models.TextField('path of file', editable=True)
...
class Category(models.Model):
    category_index = models.CharField('index of category', max_length=500, editable=True, unique=True, blank=False)
    category_name = models.CharField('category name', max_length=200, editable=True, unique=False, blank=False)
