        ...
        keyboard.append(
            [
                InlineKeyboardButton(subcategories[i].title,
                                     switch_inline_query_current_chat='_' + subcategories[i].slug,
                                     ),
                InlineKeyboardButton(subcategories[int(len_subc / 2) + i].title,
                                     switch_inline_query_current_chat='_' + subcategories[int(len_subc / 2) + i].slug,
                                     )
            ]
        )
    if len_subc % 2 != 0:
        keyboard.append(
            [
                InlineKeyboardButton(subcategories[len_subc - 1].title,
                                     switch_inline_query_current_chat='_' + subcategories[len_subc - 1].slug,
                                     )
            ]
        )
...
async def voice_inline_query(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    slug_subcategory = update.inline_query.query.split('_')[1]
